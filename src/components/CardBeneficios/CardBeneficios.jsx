  ...
  return (
    <div className="sectionCardBeneficios">
      ...
      <div className="containerCardBeneficios">
        <div className="group1">
          <div className="cardBeneficio">
            ...
            <div className="textoeImagem">
              <p>
                Seja atendido em qualquer estado do brasil online ou fisicamente
              </p>
          ...
          <div className="cardBeneficio">
            ...
            <div className="textoeImagem">
              <p>
                Centenas de profissionais de saúde esperando seu agendamento
              </p>
          ...
          <div className="cardBeneficio">
            ...
            <div className="textoeImagem">
              <p>
                Diversas especialidades disponíveis em telemedicina através do
                celular
              </p>
        ...
        <img
          className="imgCardBeneficios"
          src="../assets/images/lab-app-cellphone.webp"
          alt="telefone"
        />
        <div className="group2">
          <div className="cardBeneficio">
            ...
            <div className="textoeImagem">
              <p>
                Cooparticação da empresa e até 12x de parcelamento no crédito
                para consultas
              </p>
          ...
          <div className="cardBeneficio">
            ...
            <div className="textoeImagem">
              <p>
                Salve os atestados e prescrições online e compartilhe com a
                empresa
              </p>
          ...
          <div className="cardBeneficio2">
            ...
            <div className="textoeImagem">
              <p>
                Nunca esqueça de cumprir as orientações profissionais com
                lembretes de tratamento da Lab
              </p>
